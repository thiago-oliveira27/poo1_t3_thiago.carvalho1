...
public class Main4 {
    public static void main(String[]args){
    	...
    	FigExtras figLegend = new Figurinha3("Thiago",LocalDate.parse("2003-04-12"),1.73f,70.0f,"centro-avante","Brazil","Legend", "Bordô");

        mostrarFigurinha(figNormal);
        mostrarFigurinha(figLegend);
